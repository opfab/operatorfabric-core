...
bin/prepare_release_version.sh:: performs the changes necessary to tag a RELEASE version
bin/prepare_snapshot_version.sh:: performs the changes necessary to tag a SNAPSHOT version
