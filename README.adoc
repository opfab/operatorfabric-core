...
. After a little while, log into the application UI at *localhost:2002/* using operator1/test as credentials.
...
image:https://img.shields.io/badge/Using-Github%20CI-%23FF647D.svg?style=for-the-badge[Using Githubactions  CI,link=https://github.com/opfab/operatorfabric-core/actions]
