...
WARNING: The steps below assume that you have installed and are using https://sdkman.io/[sdkman] and
https://github.com/creationix/nvm[nvm] to manage tool versions ( for java, gradle, node and npm).
...
TIP: From now on, you can use environment variable $OF_HOME to go back to the home repository of OperatorFabric.
...
If it hasn't be done before, a docker network need to be configured for the containers using the following command:
----
...
TIP: In addition, a link:https://opfab.github.io/documentation/0.1.1.RELEASE/start/[Getting Started guide on our website] exists.
Check it out !
...
information on tasks, refer to the output of the "tasks" gradle task and to gradle
...
Read our link:CONTRIBUTING.adoc[CONTRIBUTING] file for more information on how to contribute to the project.
