...
import MongoSupervisorDatabaseService from './domain/server-side/mongoSupervisorDatabaseService';
...
const supervisorDatabaseService = new MongoSupervisorDatabaseService()
