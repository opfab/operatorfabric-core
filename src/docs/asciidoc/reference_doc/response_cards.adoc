...
https://github.com/opfab/operatorfabric-core/tree/master/src/test/resources/bundles/userCardExamples/template/incidentInProgress.handlebars[src/test/resources/bundles/userCardExamples/template/incidentInProgress.handlebars].
...
An example of usage can be found in the file https://github.com/opfab/operatorfabric-core/tree/master/src/test/resources/bundles/userCardExamples2/template/question.handlebars[src/test/resources/bundles/userCardExamples2/template/question.handlebars].