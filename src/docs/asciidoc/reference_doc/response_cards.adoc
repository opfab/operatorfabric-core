...
An example of _templateGateway.isUserAllowedToRespond()_ usage can be found in the file src/test/resources/bundles/defaultProcess_V1/template/en/incidentInProgress.handlebars.
...
An example of _templateGateway.isUserMemberOfAnEntityRequiredToRespond()_ usage can be found in the file src/test/resources/bundles/defaultProcess_V1/template/en/question.handlebars.
