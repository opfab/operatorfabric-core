...
[source,js]
----
include::../../../test/resources/bundles/defaultProcess_V1/template/en/question.handlebars[tag=templateGateway.validyForm_example]
----
...
An example of templateGateway.setUserCanRespond() implementation can be found in the file src/test/resources/bundles/defaultProcess_V1/template/en/incidentInProgress.handlebars.
