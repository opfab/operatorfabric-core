...
An example of usage can be found in operator fabric git: (https://github.com/opfab/operatorfabric-core/tree/master/src/test/resources/bundles/userCardExamples2/template/question.handlebars[src/test/resources/bundles/userCardExamples2/template/question.handlebars]).
