...
.src/test/utils/karate/businessconfig/resources/bundle_defaultProcess/template/en/chart.handlebars
[source,html]
----
include::../../../test/utils/karate/businessconfig/resources/bundle_defaultProcess/template/en/chart.handlebars[tag=templateGateway.redirectToBusinessMenu_example]
----
