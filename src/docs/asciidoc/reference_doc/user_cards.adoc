...
core repository under (https://github.com/opfab/operatorfabric-core/blob/{gitReference}/src/test/resources/bundles/conferenceAndITIncidentExample[src/test/resources/bundles/conferenceAndITIncidentExample]).
...
https://github.com/opfab/operatorfabric-core/blob/{gitReference}/src/test/resources/bundles/taskExample/template/usercard_task.handlebars[src/test/resources/bundles/taskExample/template/usercard_task.handlebars].
