...
NOTE: The list of 'recipients for information' can also be limited via javascript in the user template.
...
NOTE: The list of initially selected 'recipients for information' can also be configured via javascript in the user
...
== Get selected recipient entities for information list
The template can know the list of entities selected by the users as recipients for information of the card by calling
