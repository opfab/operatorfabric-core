...
When editing a user card, the template can get the response sent by current user by calling the _opfab.currentUserCard.getUserEntityChildCard_ function. 
