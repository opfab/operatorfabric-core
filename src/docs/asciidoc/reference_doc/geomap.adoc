...
The example configuration references a GeoJSON layer from  Open Data GRD (https://opendata.agenceore.fr) published under open licence v2.0 https://www.etalab.gouv.fr/wp-content/uploads/2017/04/ETALAB-Licence-Ouverte-v2.0.pdf 
