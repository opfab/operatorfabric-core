...
You can define pre-selected values for the type of state multiselect by setting the field `defaultSelectedTypeOfState`.
The possible values are `INPROGRESS`, `FINISHED`, `CANCELED`.
