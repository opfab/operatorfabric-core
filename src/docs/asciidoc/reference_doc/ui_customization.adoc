...
It is possible to define the minimum width of the column by setting the `minWidth` field in the column definition. The `minWidth` is a number representing the width in pixels.
