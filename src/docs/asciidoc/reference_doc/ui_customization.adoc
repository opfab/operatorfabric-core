...
The `cardField` is the field of the card that will be displayed in the result. It is not used for the following field types: `COLORED_CIRCLE`, `SEVERITY`, `TYPE_OF_STATE`,`RESPONSES` and `RESPONSE_FROM_MY_ENTITIES`.
