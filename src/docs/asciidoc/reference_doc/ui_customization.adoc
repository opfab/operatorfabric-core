...
- for the read and ack multiselect fitler by setting the field `defaultSelectedReadAndAck`. The possible values are `READ`, `NOT_READ`, `ACKNOWLEDGED`, `NOT_ACKNOWLEDGED`.
