...
In opfab git repository, you can find in directory https://github.com/opfab/operatorfabric-core/blob/{gitReference}/src/test/resources/monitoringConfig[src/test/resources/monitoringConfig]  : 
