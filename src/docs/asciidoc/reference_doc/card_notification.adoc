...
When the user receives a new card, they can see it in the feed with a bold  white title and card resume. Once the card is opened, the texts unbolds and  becomes grey.
