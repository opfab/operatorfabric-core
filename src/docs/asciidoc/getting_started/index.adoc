...
----
{
	...
	"states":{
		"messageState" : {
			"detailTitle" : { "key" : "defaultProcess.title"},
...
[source,JSON]
----
{"statesData":{"messageState":{"responseData":null,"acknowledgementAllowed":true,"color":null,"name":null,"userCardTemplate":null,"detailTitle":{"key":"defaultProcess.title","parameters":null},"templateName":"template","styles":["style"],"acknowledgmentAllowed":true,"response":null}},"id":"defaultProcess","name":null,"version":"2","uiVisibility":null,"states":{"messageState":{"responseData":null,"acknowledgementAllowed":true,"color":null,"name":null,"userCardTemplate":null,"detailTitle":{"key":"defaultProcess.title","parameters":null},"templateName":"template","styles":["style"],"acknowledgmentAllowed":true,"response":null}}}
----
...
----
{
	...
	"states":{
		"criticalSituation-begin" : {
			"detailTitle" : { "key" : "criticalSituation-begin.title"},
			"templateName" : "criticalSituationTemplate",
			"styles" : [ "style" ],
			"acknowledgementAllowed": true
		},
		"criticalSituation-update" : {
			"detailTitle" : { "key" : "criticalSituation-update.title"},
			"templateName" : "criticalSituationTemplate",
			"styles" : [ "style" ],
			"acknowledgementAllowed": true
		},
		"criticalSituation-end" : {
			"detailTitle" : { "key" : "criticalSituation-end.title"},
