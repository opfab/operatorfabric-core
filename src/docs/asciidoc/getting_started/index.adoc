...
Test the connection to the UI: to connect to OperatorFabric, open in a browser the following page: http://localhost:2002/ui/ and use `operator1_fr` as login and `test` as password.
...
See the link:https://opfab.github.io/documentation/current/reference_doc/#user_cards[card documentation] for further informations on cards.
