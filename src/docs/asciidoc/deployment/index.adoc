...
To get the log level for ROOT logger of a java service it is possible to use opfab CLI "service" command:
----
opfab service get-log-level <serviceName>
----
...
To set the log level for ROOT logger of a java service it is possible to use opfab CLI "service" command:
----
opfab service set-log-level <serviceName> <level>
----
...
To get the log level for a node service it is possible to use opfab CLI "service" command:
----
opfab service get-log-level <serviceName>
----
...
To set the log level for a node service it is possible to use opfab CLI "service" command:
----
opfab service set-log-level <serviceName> <level>
----
