...
ifndef::single-page-doc[<<{gradle-rootdir}/documentation/current/deployment/index.adoc#cloud_config_service_config, Cloud Configuration Service>>]
and
ifdef::single-page-doc[<<cloud_registry_service_config, Cloud Registry Service>>]
ifndef::single-page-doc[<<{gradle-rootdir}/documentation/current/deployment/index.adoc#cloud_registry_service_config, Cloud Registry Service>>]
