...
|feed.geomap.layer.geojson.url|null|no|List of GeoJSON layers to add to the map. Example: ["https://localhost:8000/service-area.geojson","https://localhost:8000/network-lines.geojson"]
