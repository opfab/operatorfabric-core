...
A new setting has been added to set on which day a week starts. The parameter `settings.weekStartsOn` is 1 by default, implying Monday is the first day. The day mapping is as follows :
