...
:opfab_architecture_doc: https://opfab.github.io/documentation/0.10.1.SNAPSHOT/architecture/
...
|operatorfabric.security.jwt.expire-claim|exp|no| Jwt claim is used as a token expiration timestamp
|===
