...
ifndef::single-page-doc[<<{gradle-rootdir}/documentation/current/community/index.adoc#license_and_DCO, Developer Certificate of Origin>>]
.
...
* Check that Travis build is passing for the PR
...
* Check new dependencies added to the project to see if they are compatible with the OperatorFabric license
