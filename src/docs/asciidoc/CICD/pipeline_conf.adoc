...
We used Sonatype accounts to be able to push libraries to maven central. The list of people authorized to publish is defined via issues : https://issues.sonatype.org/browse/OSSRH-67392

This is now deprecated as we do not publish libraries anymore but the old one are still available.
