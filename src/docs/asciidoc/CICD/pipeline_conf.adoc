...
We use sonatype accounts to be able to push librairies to maven central. The list of people authorized to publish is defined via issues : https://issues.sonatype.org/browse/OSSRH-67392