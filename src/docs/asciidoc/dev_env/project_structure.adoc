...
OperatorFabric
** link:https://github.com/opfab/operatorfabric-core/tree/master/services[core]: contains core business microservices
...
*** link:https://github.com/opfab/operatorfabric-core/tree/master/services/src[src]: contains swagger templates for core business
microservices
