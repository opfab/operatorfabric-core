...
The documentation for the API is generated from the open api definition file `src/docs/api/openapi.yml` definitions. To generate the
...
The generate html file can be found under `src/docs/api/build`
