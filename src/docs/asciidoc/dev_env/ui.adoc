...
To log in you need to use a valid user among the following: `operator1_fr`, `operator3_fr` or `admin`.
...
Once logged in with operator1_fr, after those scripts have been running, you should be able to see some cards displayed in `http://localhost:2002/`.
