...
- Card Publication : this component receive the cards form third party tools
- Card Consultation : this component deliver the cards to the operators and provide access to all cards exchanged (archives)
...
The cards are store in a https://www.mongodb.com/[MongoDb] database. The bundles are stored in a file system 
