...
image::02_02_business_activities/Activity_Handle_Process_ProcessActivityDiagram.JPEG[Handle Business Process Instance Activity]
...
image::02_02_business_activities//Activity_Handle_Card_CardActivityDiagram.JPEG[Handle Card Input Activity]
