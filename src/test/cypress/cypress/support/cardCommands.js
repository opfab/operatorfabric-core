...
export class CardCommands extends OpfabCommands {
    ...
    checkEntityIsRedInCardHeader = function (entityId) {
        cy.get(`#opfab-card-header-entity-${entityId}`).should('have.css', 'color', 'rgb(255, 0, 0)');
    };

    checkEntityIsBlueInCardHeader = function (entityId) {
        cy.get(`#opfab-card-header-entity-${entityId}`).should('have.css', 'color', 'rgb(39, 132, 255)');
    };
    ...
    checkEntityIsGreyInCardHeader = function (entityId) {
        cy.get(`#opfab-card-header-entity-${entityId}`).should('have.css', 'color', 'rgb(108, 117, 125)');
    };
    ...
    openEntityDropdownInCardHeader() {
        cy.get('#opfab-card-response-header-right').click();
    }
