...
describe('Acknowledgment tests', function () {
    ...
    it('Check entities acknowledgments for a usercard created by operator1_fr', function () {
        ...
        cy.get('of-light-card')
            ...
            .contains('Electricity consumption forecast'.toUpperCase())
            .click();
        ...
        cy.get('of-light-card').find('.opfab-lightcard-title').contains('Message'.toUpperCase()).click();
        cy.get('#opfab-selected-card-summary').should(
            'have.text',
        ...
        cy.get('#opfab-card-acknowledged-footer')
            .find('span')
            .eq(4)
            .should('have.text', '\u00a0 Control Center FR West \u00a0')
            .and('have.css', 'color', 'rgb(255, 102, 0)');

        cy.get('#opfab-card-acknowledged-footer')
            .find('span')
            .eq(5)
            .should('have.text', '\u00a0 Control Center IT Center \u00a0')
            .and('have.css', 'color', 'rgb(255, 102, 0)');

        cy.get('#opfab-card-acknowledged-footer')
            .find('span')
            .eq(6)
            .should('have.text', '\u00a0 Control Center IT North \u00a0')
            .and('have.css', 'color', 'rgb(255, 102, 0)');

        cy.get('#opfab-card-acknowledged-footer')
            .find('span')
            .eq(7)
            .should('have.text', '\u00a0 Control Center IT South \u00a0')
            .and('have.css', 'color', 'rgb(255, 102, 0)');

        cy.get('#opfab-card-acknowledged-footer')
            .find('span')
            .eq(8)
            .should('have.text', '\u00a0 Control Center NL North \u00a0')
            .and('have.css', 'color', 'rgb(255, 102, 0)');

        cy.get('#opfab-card-acknowledged-footer')
            .find('span')
            .eq(9)
            .should('have.text', '\u00a0 Control Center NL South \u00a0')
            .and('have.css', 'color', 'rgb(255, 102, 0)');

        cy.get('#opfab-card-acknowledged-footer')
            .find('span')
            .eq(10)
            .should('have.text', '\u00a0 IT SUPERVISION CENTER \u00a0')
            .and('have.css', 'color', 'rgb(255, 102, 0)');

        cy.get('#opfab-card-acknowledged-footer')
            .find('span')
            .eq(11)
            .should('have.text', '\u00a0 North Europe Control Center \u00a0')
            .and('have.css', 'color', 'rgb(255, 102, 0)');

        cy.get('#opfab-card-acknowledged-footer')
            .find('span')
            .eq(12)
            .should('have.text', '\u00a0 South Europe Control Center \u00a0')
            .and('have.css', 'color', 'rgb(255, 102, 0)');
    ...
    it('Check pinned card is removed after end date', function () {
        ...
        script.sendCard('cypress/feed/customEvent.json', {
            startDate: deltaTime - 2 * HOURS,
            endDate: deltaTime + 5 * MINUTES
        });
