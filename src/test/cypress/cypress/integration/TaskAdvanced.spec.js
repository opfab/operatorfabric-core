...
describe('Task Advanced', function () {
    ...
    describe('Send task advanced user card', function () {
        ...
        it('Check task advanced card appears on the timeline and calendar', function () {
            ...
            // So we just check the fact that there is a repetition
            cy.get('.opfab-calendar-event').should('have.length.greaterThan', 3);
    ...
    function checkHaveAtLeastCircle(nb) {
        cy.get('of-custom-timeline-chart')
            .find('ellipse')
            .should('have.length.greaterThan', nb - 1);
    }
