...
IMPORTANT: Some tests are failing with the latest version of Karate (v0.9.6) so for the time being please use
link:https://github.com/intuit/karate/releases/tag/v0.9.5[v0.9.5] instead.
Issue link:https://opfab.atlassian.net/browse/OC-1537[OC-1537] has been logged to look into it.
