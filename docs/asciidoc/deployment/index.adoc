...
* delete old cards based on `operatorfabric.cards-publication.purge.defaultDaysToKeepCardsAfterPublication`
* delete archived cards based on `operatorfabric.cards-publication.purge.defaultDaysToKeepArchivesCardsAfterPublication`
