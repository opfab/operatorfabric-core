...
The UI components shall contain as little as possible business code.

The API component is a gateway to access business method, it shall not contain any logic.
