...
Your can find example using these classes in the OperatorFabric core repository (https://github.com/opfab/operatorfabric-core/blob/{gitReference}/test/resources/bundles[test/resources/bundles]).
