...
Your can find example using these classes in the OperatorFabric core repository (https://github.com/opfab/operatorfabric-core/blob/{gitReference}/src/test/resources/bundles[src/test/resources/bundles]).
