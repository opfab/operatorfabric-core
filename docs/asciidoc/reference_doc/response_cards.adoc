...
.test/resources/bundles/defaultProcess_V1/template/question.handlebars
[source,js]
----
include::../../../test/resources/bundles/defaultProcess_V1/template/question.handlebars[tag=functionToGetUserResponse_example]
...
You can find an example in the file https://github.com/opfab/operatorfabric-core/blob/{gitReference}/test/resources/bundles/defaultProcess_V1/template/question.handlebars[test/resources/bundles/defaultProcess_V1/template/question.handlebars].
