...
You can find an example in the file https://github.com/opfab/operatorfabric-core/blob/{gitReference}/src/test/resources/bundles/defaultProcess_V1/template/question.handlebars[src/test/resources/bundles/defaultProcess_V1/template/question.handlebars].
