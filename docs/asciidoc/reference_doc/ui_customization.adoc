...
Clicking on the title of a custom tile does not trigger any navigation.
Navigation is only available through the cells, which open the associated custom screens.
