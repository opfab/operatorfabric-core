...
The maximum size of a card is 1.5 Mb. This limit is enforced to avoid bloating the mongo database and for performance reasons.
...
ifdef::single-page-doc[link:../api/index.html#tag/cards-publication[the cards publication api documentation]]
ifndef::single-page-doc[link:/documentation/current/api/index.html#tag/cards-publication[the cards publication api documentation]]
