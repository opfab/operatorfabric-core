...
[source,JSON]
----
include::../../../../backend/businessconfig/src/main/docker/volume/businessconfig-storage/TEST/config.json[]
----

- `id`: id of the process;
- `name`: process name;
- `version`: enables the correct display of the card data, even for the old ones.
The server stores the previous versions in its file system.
...
- `uiVisibility`: in the logging and calendar screens, not all the cards are visible, it depends on the business process they are part of. For a card to be visible in these screens, the corresponding parameter must be set to true.

The mandatory field are `id`,`name` and `version`.

See the
ifdef::single-page-doc[link:../api/index.html#tag/processes[Processes API documentation]]
ifndef::single-page-doc[link:/documentation/current/api/index.html#tag/processes[Processes API documentation]]
for details.
...
[source,JSON]
----
include::../../../../backend/businessconfig/src/main/docker/volume/businessconfig-storage/TEST/1/i18n.json[]
----
...
ifdef::single-page-doc[link:../api/index.html#tag/processes/operation/getI18n[here]]
ifndef::single-page-doc[link:/documentation/current/api/index.html#tag/processes/operation/getI18n[here]]
.
...
For more advance feature, go to the section detailing the handlebar templates and associated helpers available in OperatorFabric.
As the card used in this example is created above, the bundle template folder needs to contain 2 templates: `template1.handlebars` and `template2.handlebars`.
...
ifdef::single-page-doc[<<../api/index.html#tag/processes/operation/postBundle, Processes API documentation>>]
ifndef::single-page-doc[<</documentation/current/api/index.html#tag/processes/operation/postBundle, Processes API documentation>>]
.
...
ifdef::single-page-doc[link:../api/index.html#tag/processes/operation/uploadProcessgroups[Processes API documentation]]
ifndef::single-page-doc[link:/documentation/current/api/index.html#tag/processes/operation/uploadProcessgroups[Processes API documentation]]
.
