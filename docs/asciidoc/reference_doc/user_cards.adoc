...
core repository under (https://github.com/opfab/operatorfabric-core/blob/{gitReference}/test/resources/bundles/conferenceAndITIncidentExample[test/resources/bundles/conferenceAndITIncidentExample]).
...
https://github.com/opfab/operatorfabric-core/blob/{gitReference}/test/resources/bundles/taskExample/template/usercard_task.handlebars[test/resources/bundles/taskExample/template/usercard_task.handlebars].
