...
An example of usage can be found in the file
https://github.com/opfab/operatorfabric-core/blob/{gitReference}/test/resources/bundles/conferenceAndITIncidentExample/template/incidentInProgress.handlebars[test/resources/bundles/conferenceAndITIncidentExample/template/incidentInProgress.handlebars].
...
An example of usage can be found in the file https://github.com/opfab/operatorfabric-core/blob/{gitReference}/test/resources/bundles/defaultProcess_V1/template/question.handlebars[test/resources/bundles/defaultProcess_V1/template/question.handlebars].
