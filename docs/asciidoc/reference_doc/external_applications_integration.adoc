...
Your can find an example of a web page using these resources in the OperatorFabric core repository (https://github.com/opfab/operatorfabric-core/blob/{gitReference}/test/externalWebAppExample/index.html[test/externalWebAppExample/index.html]).
