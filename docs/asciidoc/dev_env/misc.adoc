...
The sources for the documentation are located under `docs/asciidoc`. To generate HTML pages from these sources,
...
The documentation for the API is generated from the open api definition file `docs/api/openapi.yml` definitions. To generate the
API documentation, use the `generateOpenApiDocs` gradle task:
...
The generate html file can be found under `docs/api/build`
