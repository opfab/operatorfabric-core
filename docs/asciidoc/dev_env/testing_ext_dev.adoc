...
`test/dummyModbusDevice/src/main/resources/application.yml`.
...
See the https://github.com/opfab/operatorfabric-core/blob/develop/test/dummyModbusDevice/README.adoc[README for the Dummy Modbus Device module].
