...
describe('Entity acknowledgment tests for icon in light-card', function () {
    ...
    it('Check if dashboard works correctly', function () {
        ...
        // There are 37 bubbles on the dashboard (35 states with 1 grey bubble and 1 state with 2 bubbles)
    ...
    it('Check redirection to filtered Feed page or business menu', function () {
        ...
        cy.get('.opfab-dashboard-tile').eq(4).contains('Process example');
        cy.get('.opfab-dashboard-tile').eq(4).find('.opfab-cell-link').eq(0).contains('Process example').click();
        ...
        cy.get('.opfab-dashboard-tile').eq(4).find('.opfab-cell-link').eq(5).contains('Message').click();
        ...
        cy.get('.opfab-dashboard-tile').eq(4).find('.opfab-cell-link').eq(3).contains('Data quality').click();
        ...
        cy.get('.opfab-dashboard-tile').eq(8).contains('Test process for cypress').click();
