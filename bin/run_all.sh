...
startProject(){
      ...
      applicationOptions="--spring.profiles.active=java --spring.config.location=classpath:/application.yml,file:${OF_HOME}/config/services/ --spring.config.name=common,$4"
