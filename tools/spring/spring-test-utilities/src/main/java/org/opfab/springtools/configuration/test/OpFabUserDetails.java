 ...
 * A separate class had to be created in the users-service module for the same purpose (see details there) so any changes made in this class should be reflected there.
 *
 *
 */
