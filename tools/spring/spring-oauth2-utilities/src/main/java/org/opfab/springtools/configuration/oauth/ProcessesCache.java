...
public class ProcessesCache {
    ...
    public Process fetchProcessFromCacheOrProxy(String process, String version, String user) throws FeignException {
        return client.getProcess(process, version, "Bearer " + tokens.get(user));
    }
