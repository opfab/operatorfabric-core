...
export class ActivityAreaChoiceAferLoginComponent implements OnInit {
    private modalRef: NgbModalRef;
    @ViewChild('activityArea') activityAreaPopupRef: TemplateRef<any>;

    @Output() public activityAreaChoiceDone = new Subject();
    ...
    sendActivityAreaChoiceDone() {
        this.activityAreaChoiceDone.next(true);
        this.activityAreaChoiceDone.complete();
    }
}
