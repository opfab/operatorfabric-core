...
describe('flatten simple objects ', () => {
  ...
  it('flatten objet with epochDate convert to date  ', () => {
  ...
  it('flatten objet with epochDate convert to date but invalid epoch date -> should not convert and keep initial value  ', () => {
