...
opfab.richTextEditor = {
    ...
    getEditor: function(id, content, onChangeCallback, onReadyCallback) {
        return new EditorJS( {
            holder : id,
            data: content,
            i18n: this.translations[this.locale],
...
class RichTextEditor extends HTMLElement {
    ...
    constructor() {
        ...
        this.editor = opfab.richTextEditor.getEditor(this.id, null, (api, event) => {
    ...
    setContent(data) {
        if (data) {
            ...
            this.editor = opfab.richTextEditor.getEditor(this.id, contentObj, (api, event) => {
                    this.editor.save().then( outData => {
                        this.content = outData;
                    })
                },
