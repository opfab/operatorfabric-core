...
export function getOneLightCard(lightCardTemplate?: any): Card {
    ...
    return new Card(
        ...
        lightCardTemplate.hasBeenAcknowledged,
        lightCardTemplate.hasBeenRead,
        lightCardTemplate.hasChildCardFromCurrentUserEntity ?? false,
        lightCardTemplate.isNotificationFiltered ?? false,
        ...
        lightCardTemplate.titleTranslated ?? 'testTitleTranslated',
        lightCardTemplate.summaryTranslated ?? 'testSummaryTranslated',
