...
export class OpfabStore {
    ...
    public static init(processStatesToSendEvenIfNotNotified: string[]) {
        OpfabStore.lightCardsStore.initStore(processStatesToSendEvenIfNotNotified);
    }

    // This method shall only be used for testing purposes
    public static reset(processStatesToSendEvenIfNotNotified: string[] = []) {
        ...
        OpfabStore.init(processStatesToSendEvenIfNotNotified);
    }
}
