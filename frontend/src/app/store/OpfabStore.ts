...
export class OpfabStore {
    ...
    public static init(loadNotNotifiedLightCards: boolean) {
        OpfabStore.lightCardsStore.initStore(loadNotNotifiedLightCards);
    }

    // This method shall only be used for testing purposes
    public static reset(loadNotNotifiedLightCards: boolean = false) {
        ...
        OpfabStore.init(loadNotNotifiedLightCards);
    }
}
