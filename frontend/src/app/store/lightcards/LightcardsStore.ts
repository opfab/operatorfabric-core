...
export class LightCardsStore {
    ...
    // we can set this variable to true to get them from the backend and have it
    // available in the store for the dashboard screen.
    private storeNotNotifedLightCards = false;
    ...
    public initStore(storeNotNotifedLightCards = false) {
        this.storeNotNotifedLightCards = storeNotNotifedLightCards;
    ...
    public addOrUpdateLightCard(card) {
        ...
        if (this.storeNotNotifedLightCards) {
