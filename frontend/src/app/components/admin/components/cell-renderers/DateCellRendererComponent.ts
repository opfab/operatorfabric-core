...
@Component({
    selector: 'of-date-cell-renderer',
    templateUrl: './DateCellRendererComponent.html',
...
export class DateCellRendererComponent implements ICellRendererAngularComp {
    ...
    agInit(params: any): void {
        this.dateString = params.value ? DateTimeFormatterService.getFormattedDate(params.value) : '';
    }
