...
To address this, we implement a custom JwtAuthenticationToken, named OpfabJwtAuthenticationToken, which can store and manage all required user information. This class contains an instance of the User class representing the current user. The class is to be found in the java common module.
