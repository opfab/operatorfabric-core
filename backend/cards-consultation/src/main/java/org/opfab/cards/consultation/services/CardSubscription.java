...
public class CardSubscription {
    ...
    private String id;
    private boolean sendNotNotifiedLightCards;
    ...
    public boolean isNotNotifiedLightCardsSent() {
        return sendNotNotifiedLightCards;
    }

    public void setNotNotifiedLightCardsSent(boolean notNotifiedLightCardsSent) {
        this.sendNotNotifiedLightCards = notNotifiedLightCardsSent;
    }
