...
class CardRoutingUtilitiesShould {
    ...
    void checkIfUserMustReceiveTheCardUsingEntitiesOnly() {
        ...
        JSONObject messageBodyWithEntityOfTheUser = createJSONObjectFromString("{" + processStateInPerimeter + ", \"entityRecipients\":[\"testentity1\", \"testentity4\"]}}");
        JSONObject messageBodyWithEntityOfTheUserButStateNotInPerimeter = createJSONObjectFromString("{" + processStateNotInPerimeter + ", \"entityRecipients\":[\"testentity1\", \"testentity4\"]}}");
        ...
        JSONObject messageBodyWithEntityOfTheUserAndEmptyGroupsList = createJSONObjectFromString("{" + processStateInPerimeter + ", \"groupRecipients\":[], \"entityRecipients\":[\"testentity1\", \"testentity4\"]}}");
        JSONObject messageBodyWithNoEntityOfTheUserAndEmptyGroupsList = createJSONObjectFromString("{" + processStateInPerimeter + ", \"groupRecipients\":[], \"entityRecipients\":[\"testentity3\", \"testentity4\"]}}");
    ...
    void checkIfUserMustReceiveTheCardUsingUserOnly() {
        ...
        JSONObject messageBodyWithTheUser = createJSONObjectFromString("{" + processStateInPerimeter + ",\"userRecipients\":[\"testuser\", \"noexistantuser2\"]}}");
        JSONObject messageBodyWithTheUserAndEntity = createJSONObjectFromString("{" + processStateInPerimeter + ",\"userRecipients\":[\"testuser\", \"noexistantuser2\"],\"entityRecipients\":[\"testentity3\", \"testentity4\"]}}");
        JSONObject messageBodyWithTheUserAndGroup = createJSONObjectFromString("{" + processStateInPerimeter + ",\"userRecipients\":[\"testuser\", \"noexistantuser2\"], \"groupRecipients\":[\"testgroup3\", \"testgroup4\"]}}");
        JSONObject messageBodyWithTheUserButStateNotInPerimeter = createJSONObjectFromString("{" + processStateNotInPerimeter + ",\"userRecipients\":[\"testuser\", \"noexistantuser2\"]}}");
        JSONObject messageBodyWithoutTheUser = createJSONObjectFromString("{" + processStateInPerimeter + ",\"userRecipients\":[\"noexistantuser1\", \"noexistantuser2\"]}}");
