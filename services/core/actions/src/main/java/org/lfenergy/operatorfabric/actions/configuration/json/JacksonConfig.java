...
public class JacksonConfig {
  ...
  /**
   * Builds object mapper adding java 8 custom configuration and business module configuration ({@link ActionsModule})
  ...
  public ObjectMapper objectMapper(Jackson2ObjectMapperBuilder builder) {
    ...
    objectMapper.registerModule(new ActionsModule());
