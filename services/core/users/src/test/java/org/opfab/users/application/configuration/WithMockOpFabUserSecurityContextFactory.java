...
public class WithMockOpFabUserSecurityContextFactory implements WithSecurityContextFactory<WithMockOpFabUser> {
    ...
    public SecurityContext createSecurityContext(WithMockOpFabUser customUser) {
        ...
        Authentication auth = new MockAuthenticationWithDetails(principal, "password", principal.getAuthorities());
    ...
    private class MockAuthenticationWithDetails extends UsernamePasswordAuthenticationToken {

        MockAuthenticationWithDetails(OpFabUserDetails principal, String password, Collection<? extends GrantedAuthority> authorities) {
