...
public class TimeController  {
    ...
    public TimeData updateTime(@AuthenticationPrincipal User user, @ApiParam(value = "Time Data to update " +
       "time service"  )
    @Valid @RequestBody TimeData time) throws Exception {
        return setTime(user, time);
    }

    @RequestMapping(value = "/speed",
       method = RequestMethod.POST)
    public SpeedEnum setCurrentSpeed(@Valid @RequestBody SpeedEnum currentspeed) throws Exception {
    ...
    @RequestMapping(value = "/current",
       method = RequestMethod.POST)
    public Long setCurrentTime(@Valid @RequestBody java.lang.Long currentTime) throws Exception {
    ...
    @RequestMapping(value = "/current",
       method = RequestMethod.PUT)
    public Long updateCurrentTime(@Valid @RequestBody java.lang.Long currentTime) throws Exception {
        return setCurrentTime(currentTime);
    }

    @RequestMapping(value = "/speed",
       method = RequestMethod.PUT)
    public SpeedEnum updateCurrentspeed(@Valid @RequestBody SpeedEnum currentspeed) throws Exception {
