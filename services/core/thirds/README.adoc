...
see https://opfab.github.io/projects/services/core/thirds/0.15.1.RELEASE/reference/#_techincal_overview[reference documentation : Technical overview ]
...
See https://opfab.github.io/projects/services/core/thirds/0.15.1.RELEASE/api/#__Models[swagger generated documentation model section] for data description

== 3. Rest Endpoints and Data Model

See https://opfab.github.io/projects/services/core/thirds/0.15.1.RELEASE/api[swagger generated documentation]
