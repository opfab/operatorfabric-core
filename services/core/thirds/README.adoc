...
see https://opfab.github.io/projects/services/core/thirds/0.14.1.SNAPSHOT/reference/#_techincal_overview[reference documentation : Technical overview ]
...
See https://opfab.github.io/projects/services/core/thirds/0.14.1.SNAPSHOT/api/#__Models[swagger generated documentation model section] for data description

== 3. Rest Endpoints and Data Model

See https://opfab.github.io/projects/services/core/thirds/0.14.1.SNAPSHOT/api[swagger generated documentation]
