...
public class CardCommandConsumerDeserializer<T extends SpecificRecord> implements Deserializer<T> {

    private final DecoderFactory decoderFactory = DecoderFactory.get();
    private final DatumReader<T> datumReader;

    public CardCommandConsumerDeserializer(DatumReader<T> datumReader) {
