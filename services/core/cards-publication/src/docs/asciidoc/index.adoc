...
For more details about possibilities about the Card Publication REST API please refer to the <<_publication_rest_api_overview>> chapter or to the link:https://opfab.github.io/projects/services/core/cards-publication/1.1.0.SNAPSHOT/api/[swagger documentation].
