...
For more details about possibilities about the Card Publication REST API please refere to the <<_publication_rest_api_overview>> chapter or to the link:https://opfab.github.io/projects/services/core/cards-publication/0.13.1.SNAPSHOT/api/[swagger documentation].
