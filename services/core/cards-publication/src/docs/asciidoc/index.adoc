...
....
curl -X POST http://localhost:2103/cards -H "Content-Type:application/type" --data @card.json
....

For more details about possibilities about the Card Publication REST API please refere to the <<_publication_rest_api_overview>> chapter or to the swagger documentation.
