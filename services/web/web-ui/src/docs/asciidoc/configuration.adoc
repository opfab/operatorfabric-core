...
|operatorfabric.settings.timeLineDefaultClusteringFormats.dateInsideTooltipsWeek|ddd DD MMM HH|no|
|operatorfabric.settings.timeLineDefaultClusteringFormats.dateInsideTooltipsMonth|ddd DD MMM YYYY|no|
|operatorfabric.settings.timeLineDefaultClusteringFormats.dateOnDay|ddd DD MMM|no|
|operatorfabric.settings.timeLineDefaultClusteringFormats.dateOnWeek|DD/MM/YY|no|
|operatorfabric.settings.timeLineDefaultClusteringFormats.dateOnMonth|MMM YY|no|
|operatorfabric.settings.timeLineDefaultClusteringFormats.dateOnYear|YYYY|no|
|operatorfabric.settings.timeLineDefaultClusteringFormats.titleDateInsideTooltips|DD/MM|no|
|operatorfabric.settings.timeLineDefaultClusteringFormats.titleHourInsideTooltips|HH:mm|no|
|operatorfabric.settings.timeLineDefaultClusteringFormats.dateOnDayNewYear|DD MMM YY|no|
|operatorfabric.settings.timeLineDefaultClusteringFormats.realTimeBarFormat|DD/MM/YY HH:mm|no|
|operatorfabric.settings.timeLineDefaultClusteringFormats.dateSimplifliedOnDayNewYear|D MMM YY|no|
|operatorfabric.settings.timeLineDefaultClusteringFormats.dateSimplifliedOnDay|D MMM|no|
|operatorfabric.settings.timeLineDefaultClusteringFormats.hoursOnly|HH|no|
|operatorfabric.settings.timeLineDefaultClusteringFormats.minutesOnly|mm|no|
|operatorfabric.settings.timeLineDefaultClusteringFormats.secondedsOnly|ss|no|
|operatorfabric.settings.timeLineDefaultClusteringFormats.weekNumberOnly|ww|no|
