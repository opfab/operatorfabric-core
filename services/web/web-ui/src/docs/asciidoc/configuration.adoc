...
|operatorfabric.settings.locale|LT|no|Default user locale (use browser if not set)
|operatorfabric.settings.default-tags||no|Default user list of filtered in tags
|operatorfabric.settings.timeLineFormats.dateInsideTooltipsWeek||no|
|operatorfabric.settings.timeLineFormats.dateInsideTooltipsWeek|ddd DD MMM HH|no|
|operatorfabric.settings.timeLineFormats.dateInsideTooltipsMonth|ddd DD MMM YYYY|no|
|operatorfabric.settings.timeLineFormats.dateOnDay|ddd DD MMM|no|
|operatorfabric.settings.timeLineFormats.dateOnWeek|DD/MM/YY|no|
|operatorfabric.settings.timeLineFormats.dateOnMonth|MMM YY|no|
|operatorfabric.settings.timeLineFormats.dateOnYear|YYYY|no|
|operatorfabric.settings.timeLineFormats.titleDateInsideTooltips|DD/MM|no|
|operatorfabric.settings.timeLineFormats.titleHourInsideTooltips|HH:mm|no|
|operatorfabric.settings.timeLineFormats.dateOnDayNewYear|DD MMM YY|no|
|operatorfabric.settings.timeLineFormats.realTimeBarFormat|DD/MM/YY HH:mm|no|
|operatorfabric.settings.timeLineFormats.dateSimplifliedOnDayNewYear|D MMM YY|no|
|operatorfabric.settings.timeLineFormats.dateSimplifliedOnDay|D MMM|no|
|operatorfabric.settings.timeLineFormats.hoursOnly|HH|no|
|operatorfabric.settings.timeLineFormats.minutesOnly|mm|no|
|operatorfabric.settings.timeLineFormats.secondedsOnly|ss|no|
|operatorfabric.settings.timeLineFormats.weekNumberOnly|ww|no|
