    ...
    class GivenAdminUserUsersControllerShould {
        ...
        void fetchSettings() throws Exception {
            ...
            result2
                    ...
                    .andExpect(content().contentType(MediaType.APPLICATION_JSON))
                    .andExpect(jsonPath("$.login", is("gchapman")))
                    .andExpect(jsonPath("$.processesStatesNotNotified").doesNotExist())
                    .andExpect(jsonPath("$.entitiesDisconnected").doesNotExist())
            ;
        ...
        void updateWithMismatchedError() throws Exception {
            ...
            mockMvc.perform(put("/users/kkline")
                    ...
                    .andExpect(jsonPath("$.message", Matchers.is(UsersController.NO_MATCHING_USER_NAME_MSG)))
                    .andExpect(jsonPath("$.errors").doesNotExist());
