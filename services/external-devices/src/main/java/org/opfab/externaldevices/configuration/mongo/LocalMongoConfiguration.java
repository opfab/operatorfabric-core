...
package org.opfab.externaldevices.configuration.mongo;
...
public class LocalMongoConfiguration extends AbstractLocalMongoConfiguration {
    ...
    public List<Converter> converterList() {
        ...
        //No specific converter so far but this class seems to be required to use @EnableOperatorFabricMongo
