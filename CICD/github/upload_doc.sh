...
git config user.email "opfabtech@gmail.com"
git config user.name "OpfabTech"
...
cp $OF_HOME/build/docs/asciidoc/docs/single_page_doc.html $HOME/documentation/documentation/archives/$OF_VERSION/docs/
cp -r $OF_HOME/build/docs/asciidoc/images/* $HOME/documentation/documentation/archives/$OF_VERSION/images/
cp -r $OF_HOME/build/docs/asciidoc/pdf/* $HOME/documentation/documentation/archives/$OF_VERSION/pdf/
